...
$lang['help_show_statusbar'] = 'Włącza pasek stanu na dole okna edytora. Ma zastosowanie tylko w panelu administacyjnym.';
$lang['allow_resize'] = 'Pozw&oacute;l zmienić wielkość';
$lang['help_allow_resize'] = 'Pozwala zmieniać wielkość okna edytora. Wymaga, by pasek statusu był włączony.';
$lang['view_html'] = 'Pokaż HTML';
$lang['friendlyname'] = 'Edytor MicroTiny WYSIWYG';
$lang['help'] = '<h3>Co robi ten moduł?</h3>
MicroTiny to mała, ograniczona wersja TinyMCE-editor, wcześniejsza wersja domyślnego edytora wysiwyg w CMS Made Simple. Obecna wersja dostarcza podstawowe opcje edycji, ale nadal jest to potężne narzędzie, ułatwiające edycję treści stron.';
...
$lang['usestaticconfig_help'] = 'To generuje statyczny plik zamiast dynamicznego. Działa lepiej na niekt&oacute;rych serwerach (np. przy uruchomionym PHP jako CGI)';
$lang['allowimages_text'] = 'Dołącz obrazki';
$lang['allowimages_help'] = 'Włączenie dodaje ikonę obrazka na pasku narzędzi, kt&oacute;ry pozwala dodać obrazek do treści.';
